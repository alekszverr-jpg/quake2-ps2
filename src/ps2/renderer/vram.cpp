...
// (TextureFootprintWords is page-granular), so the texture heap left after the
// region-sized framebuffers/z-buffer can never fragment into more blocks than
// this, no matter how many textures the cache holds.
